...
Right below these checkboxes, a separate text box called "Custom Anti-Sanction Domains" is also available — for specific sanctioned domains or services not covered by the 15 categories above. Unlike the "Custom Bypass Rules" box further down, addresses entered here are both routed directly and resolved using the same anti-sanction DNS above.
